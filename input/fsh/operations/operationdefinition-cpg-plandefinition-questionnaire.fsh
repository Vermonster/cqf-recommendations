/**
1. Add minimal or required only parameter - or should this be automatic for PD?
...
* parameter[+]
  ...
  * min = 0
  * max = "1"
  * documentation = "The [PlanDefinition](plandefinition.html) is provided directly as part of the request. Servers may choose not to accept profiles in this fashion"

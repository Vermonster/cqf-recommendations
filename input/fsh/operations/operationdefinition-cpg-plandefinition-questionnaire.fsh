...
* parameter[+]
  ...
  * min = 0
  * max = "1"
  * documentation = "If true, the questionnaire will only include only core elements from the StructureDefinition."
  * type = #boolean
* parameter[+]
